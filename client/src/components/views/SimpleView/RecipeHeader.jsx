          ...
          >
            ...
            >
              ...
              {calculateTotalTime(recipe) && (
                ...
                >
                  <AccessTimeIcon sx={{ color: "white", fontSize: "1.1rem" }} />
                  <TimeDisplay
                    timeString={calculateTotalTime(recipe)}
                    variant="body2"
                    sx={{
                      color: "white",
                      fontWeight: 500,
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {" • "}
                        {RECIPE_TYPE_LABELS[metadata.type] || "Main"}
                      </Typography>
                            ...
                            {metadata.notes.map((note, index) => (
                              <Typography
                                ...
                                sx={{
                                  ...
                                  fontSize: "0.875rem",
                                  lineHeight: 1.5,
                                  mb: index < metadata.notes.length - 1 ? 1 : 0,
                                }}
                              >
                                {note}
                              </Typography>
