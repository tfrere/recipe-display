...
class RecipeScraper:
    ...
    def __init__(self):
        ...
        self.recipe_structurer = RecipeStructurer("deepseek")  # Using deepseek as default provider
    ...
    async def _structure_recipe(self, web_content: WebContent, progress_callback: Optional[Callable[[str], None]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if source_image_url:
                ...
                # Download the image
                image_filename = await self._download_image(source_image_url, recipe_data["metadata"]["slug"])
                if image_filename:
    ...
    async def _download_image(self, image_url: str, slug: str) -> Optional[str]:
        """
